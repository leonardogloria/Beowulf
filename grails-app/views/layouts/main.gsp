...
<div class="wrapper">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img  class="user-image" alt="Avatar" src="<gravatar:generateAvatar circle="true"/>" />
                            <span class="hidden-xs"> <sec:loggedInUserInfo field='fullName'/>
                        </span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <g:link class="btn btn-default btn-flat" controller="logout" >Sair</g:link>
                                </div>
                            </li>
                        </ul>
                    </li>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p> <sec:loggedInUserInfo field='fullName'/>
                    </p>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2016 DEV 6</a>.</strong> All rights
    reserved.
    </footer>
